<template>
  <div v-show='bool' class="page__bd">
    ...
    <div class="weui-cells"  style='margin-top:0px;'>
      ...
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">性别：
          <span  style="vertical-align: middle"><span v-text='sex'></span></span>
          <!-- <span class="weui-badge" style="margin-left: 5px;">8</span> -->
        </div>
        <!-- <div class="weui-cell__ft"></div> -->
      </div>
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">畜生日期：
          <span style="vertical-align: middle"><span v-text='value'>1990-05-20</span></span>
          <!-- <span class="weui-badge" style="margin-left: 5px;">8</span> -->
        </div>
        <!-- <div class="weui-cell__ft"></div> -->
      </div>
...
export default {
  ...
  methods: {
    ...
    changeInfo(){
      // 通知changeInfo组件出现
      bus.$emit("changeInfo",{   //里面的第一个参数只要与  bus.$on 监听参数一样即可   
